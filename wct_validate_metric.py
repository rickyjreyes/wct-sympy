# WCT Validation: Emergent Effective Metric
...
# Construct effective metric: g_eff = eta + kappa * d_mu psi d_nu psi / |psi|^2
...
print("Emergent Effective Metric g_eff[mu,nu]:")
for mu in range(4):
    for nu in range(4):
        print(f"g_eff[{mu},{nu}] = ")
        sp.pprint(simplify(g_eff[mu, nu]), use_unicode=False)
        print()
