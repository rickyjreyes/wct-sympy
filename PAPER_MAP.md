...
Mapping from registry check IDs to papers / claims.
Section references are placeholders; fill in once exact paper sections are
linked.

| ID     | Claim                                                    | Paper / section (placeholder)  |
|--------|----------------------------------------------------------|--------------------------------|
...
- This document is the canonical place to record where each check ID comes
  from in the literature. Update whenever the registry grows.
- Placeholders should be replaced with concrete section/equation numbers
  before any paper-comparable claim is made.
